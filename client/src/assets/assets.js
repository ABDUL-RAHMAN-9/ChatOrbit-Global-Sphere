...
export const dummyUserData = {
    ...
    email: "admin@chatorbit.com",
    full_name: "Alex Jordan",
    username: "alex_jordan",
    bio: "🛰️ Navigating the digital sphere. | Digital Architect & Minimalist. \nDriven by curiosity and the pursuit of meaningful connection.",
...
const dummyUser2Data = {
    ...
    profile_picture:
        "https://i.pinimg.com/736x/a5/72/61/a57261c967a93a6b6ab67eb37a854405.jpg",
};
...
const dummyUser3Data = {
    ...
    profile_picture:
        "https://i.pinimg.com/736x/c1/75/de/c175de875a32f9a263d64aefb3e441f2.jpg",
};
...
export const dummyStoriesData = [
    ...
    },
    {
        ...
        content: "",
        media_url:
            "https://images.unsplash.com/photo-1567569957008-2b8f89095bb2?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", // car
        media_type: "image",
        background_color: "#4f46e5",
    ...
    },
    {
        ...
        content: "",
        media_url:
            "https://v1.pinimg.com/videos/mc/expMp4/82/71/a8/8271a8e2ef623e15e47d24c9c007021f_t1.mp4", // video
        media_type: "video",
        background_color: "#4f46e5",
...
export const dummyPostsData = [
    {
        ...
        user: dummyUserData,
        content:
            "A focused team with expansive goals—transforming ideas into products, and products into lasting love from users.",
        image_urls: [
            // team work
            "https://images.unsplash.com/photo-1542744173-8e7e53415bb0?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
        ],
    ...
    },
    {
        ...
        user: dummyUserData,
        content:
            "Your potential is waiting—progress is built in moments. Stay sharp, stay steady, and believe in the process. Every sunrise brings a new chance to level up. 🌞🌱\n#MotivationDaily #MindsetShift #KeepGoing #LevelUp #FocusForward #SuccessJourney #PositiveVibes #SmallStepsBigWins",
        image_urls: [],
        post_type: "text",
        likes_count: [],
    ...
    },
    {
        ...
        user: dummyUserData,
        content:
            "Here's a quick snapshot of how #hashtags shape conversations—from #branding to #digitalstrategy. Let's uncover their impact!",
        image_urls: [],
        post_type: "text",
        likes_count: [],
