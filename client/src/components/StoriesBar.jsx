            ...
            <div className='flex gap-4 pb-5'>
                ...
                {/* Story Cards */}
                {
                    Stories.map((story, index) => (
                        <div key={index} className={`relative rounded-lg shodow min-w-30 max-w-30 max-h-40 
                         ...
                         from-indigo-500 to-purple-600 hover:from-indigo-700 hover:to-purple-800
                          active:scale-95`}>
                            <img src={story.user.profile_picture} alt=""
                                className='absolute size-8 top-3 left-3 z-10 rounded-full ring ring-gray-100 shodow'
                            />
