...
const StoryModal = ({ setShowModal, fetchStories }) =>
{
    ...
    // after connecting the backend complete this
        ...
        <div className="fixed inset-0 z-100 min-h-screen bg-black/80 backdrop-blur text-white flex items-center justify-center p-4">
            <div className="w-full max-w-md">
                <div className="text-center mb-4 flex items-center justify-between">
                    ...
                    <h2 className="text-lg font-semibold">Create Stroy</h2>
                ...
                <button
                    ...
                    className="flex items-center justify-center gap-2 text-white py-3 mt-4 w-full rounded bg-gradient-to-r from-indigo-500 to-purple-600 cursor-pointer" >
                    <Sparkle
                        size={18}
                    />
                    Create Story
